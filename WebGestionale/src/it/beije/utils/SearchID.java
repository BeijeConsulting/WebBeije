...
public class SearchID {
	...
	public static String CercaID() {
		...
		try {
			...
			String query = "SELECT * from tabella_dipendenti where id = '"+id+"' ";
			...
			while (rset.next()) {
				...
				builder.append(id1).append("&nbsp&nbsp|&nbsp&nbsp").append(nome).append("&nbsp&nbsp|&nbsp&nbsp").append(cognome).append("&nbsp&nbsp|&nbsp&nbsp").append(data_nascita).append("&nbsp&nbsp|&nbsp&nbsp").append(luogo_nascita)
